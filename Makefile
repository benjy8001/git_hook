...
add-hosts:host-manager
	sudo ./host-manager -add front.local.promos.samsung.fr 127.0.0.1
	sudo ./host-manager -add back.local.promos.samsung.fr 127.0.0.1
	sudo ./host-manager -add api.local.promos.samsung.fr 127.0.0.1
	sudo ./host-manager -add rec.promos.samsung.fr 10.128.0.99
	sudo ./host-manager -add back.rec.promos.samsung.fr 10.128.0.99
	sudo ./host-manager -add api.rec.promos.samsung.fr 10.128.0.99

remove-hosts:login-sudo
	sudo ./host-manager -remove front.local.promos.samsung.fr
	sudo ./host-manager -remove back.local.promos.samsung.fr
	sudo ./host-manager -remove api.local.promos.samsung.fr
	sudo ./host-manager -remove rec.promos.samsung.fr
	sudo ./host-manager -remove back.rec.promos.samsung.fr
	sudo ./host-manager -remove api.rec.promos.samsung.fr
